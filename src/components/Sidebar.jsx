...
const NAV_ITEMS = [
  ...
  { to: '/operateurs', label: 'Opérateurs', icon: Building2, permission: 'operators.read' },
  { to: '/utilisateurs', label: 'Comptes utilisateurs', icon: ShieldCheck, permission: 'users.read' },
